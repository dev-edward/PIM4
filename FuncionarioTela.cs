...
{
    internal static class FuncionarioTela
    {
        ...
        internal static void CarregarForm(Form _principal)
        {
            CarregarControles();
        ...
        internal static void ConsultarFuncionario()
        {

            FuncionarioDAO consulta = new FuncionarioDAO();
            Funcionario funcionario = new Funcionario();
            
            funcionario = consulta.Consultar(2);

            //txtEmpresa = funcionario.empresa;
            txtNome.Text = funcionario.nome;
            
            dtpNascimento.Value = funcionario.dataNascimento;
            cmbEstadoCivil.SelectedIndex = funcionario.estadoCivil;
            cmbSexo.SelectedIndex = funcionario.sexo;
            ...
            cmbMunicipio.SelectedIndex = funcionario.municipio;
            cmbEstado.SelectedIndex = funcionario.estado;
            cmbPais.SelectedIndex = funcionario.pais;
            txtCargo.Text = funcionario.cargo;
            txtSetor.Text = funcionario.setor;
            cmbTipoContrato.SelectedIndex = funcionario.tipoContrato;
            txtSalario.Text = Convert.ToString(funcionario.salario);
            txtJornada.Text = Convert.ToString(funcionario.jornada);
        ...
        private static void Cadastrar(object sender, EventArgs e)
        {
            ...
            funcionario.estadoCivil = cmbEstadoCivil.SelectedIndex;
            funcionario.sexo = cmbSexo.SelectedIndex;
            ...
            funcionario.municipio = cmbMunicipio.SelectedIndex;
            funcionario.estado = cmbEstado.SelectedIndex;
            funcionario.pais = cmbPais.SelectedIndex;
            funcionario.cargo = txtCargo.Text;
            funcionario.setor = txtSetor.Text;
            funcionario.tipoContrato = cmbTipoContrato.SelectedIndex;
            funcionario.salario = float.Parse(txtSalario.Text);
            funcionario.jornada = int.Parse(txtJornada.Text);
            funcionario.dataAdmissao = dtpDataAdmissao.Value;
